...
proc isConcreteType*(typ: Type): bool =
  ...
  typ.kind == TkPrimitive or (typ.kind == TkMeta and typ.metaKind notin {MkIntInfer, MkFloatInfer, MkUIntInfer, MkToInfer})
...
proc inferExpressionType*(inferencer: TypeInferencer, scope: Scope, node: Node): Type =
  ...
  of NkUnaryExpr:
    ...
    of TkMinus:
      ...
      if operand.kind == TkPrimitive and operand.primitive in {Int, Int8, Int16, Int32, Int64, 
